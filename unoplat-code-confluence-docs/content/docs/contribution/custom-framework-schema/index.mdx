...
import { FrameworkCatalogSummary } from '../../../../src/components/framework-catalog-summary';
...
1. Define a machine-enforceable detection contract for framework/library features based on programming constructs like annotations, calls, imports etc.
...
### Frameworks Supported (Catalog)

The catalog below shows what is currently available by programming language. This is generated from static assets and kept in sync with ingestion framework definitions.

<FrameworkCatalogSummary />
...
<TypeTable
  type={{
    ...
    FunctionDefinition: {
      description: 'Exported function declarations used as framework entrypoints (for example route handlers)',
      type: 'enum',
    },
  }}
/>
...
<TypeTable
  type={{
    ...
    base_confidence: {
      description: 'Baseline confidence score for this feature definition; use lower values for ambiguous call patterns',
      type: 'number (0.0 - 1.0)',
      default: '0.85',
    },
  }}
...
<TypeTable
  type={{
    ...
    function_name_regex: {
      description: 'Regular expression for function declaration names. Best used with FunctionDefinition concept.',
      type: 'string (regex)',
      default: 'undefined',
    },
    export_name_regex: {
      description: 'Regular expression for exported symbol names. Best used with FunctionDefinition concept.',
      type: 'string (regex)',
      default: 'undefined',
    },
  }}
