...
The following capability families are taken from [`custom-framework-lib-schema.json`](/schemas/custom-framework-lib-schema.json). Only these values are accepted as capability keys.
