...
description: "How to report errors from Unoplat Code Confluence operations"
---
...
**Unoplat Code Confluence** includes a built-in error reporting system that automatically creates GitHub issues when operations fail. This helps us track and resolve issues quickly while providing you with a way to monitor the progress of your reported errors.
...
Error reporting is available for all **Unoplat Code Confluence** operations:
...
If you need immediate assistance or want to discuss an issue with the community, join our [Discord Community](https://discord.gg/qe2nbQMnWB).
</Callout>
