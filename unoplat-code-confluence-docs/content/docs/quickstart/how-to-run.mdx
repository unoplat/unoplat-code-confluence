...
- **Development Workflow Guide** — *Development practices*, build processes, and patterns
- **Dependency Guide** — Dependency analysis and *package configuration*
- **Business Domain Guide** — Core functionality and *domain logic*
- **App Interfaces Guide** — API endpoints, *interface contracts*, and integrations

Once generation completes, you can:
- Click **Give Feedback** to rate the generated agents with thumbs up/down ratings
- Click **Open PR** to create a pull request with the generated `AGENTS.md` changes
- Switch to the **Statistics** tab to view usage metrics for the generation run
