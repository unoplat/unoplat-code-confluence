...
### 6. Configure Exa Search Tool

After configuring your model provider, set up **Exa Search** to enable *documentation search* capabilities for AI agents.

- Navigate to **Settings > Tool Configuration** in the application
- **Unoplat Code Confluence** uses Exa for *intelligent documentation search* during code analysis

#### Setup Steps

1. Click **Configure** next to **Exa Search**
...
Exa provides AI-powered search capabilities for finding relevant documentation and web content.
</Callout>

<Callout type="info" title="Why Exa?">
**Unoplat Code Confluence** uses Exa for documentation search to help AI agents find relevant external documentation, library references, and best practices during code analysis.
</Callout>
...
2. **Community Support**
   - Join our [**Discord Community**](https://discord.gg/qe2nbQMnWB) to:
