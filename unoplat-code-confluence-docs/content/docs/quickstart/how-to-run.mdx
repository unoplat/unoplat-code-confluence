...
![Enter GitHub PAT Token](../../../src/assets/images/new_github_token.png)
...
![Developer Mode](../../../src/assets/images/developer_mode.png)
...
- **Click the "Workflow Orchestrator" button** to open the [Temporal](https://temporal.io/) workflow orchestrator dashboard.

#### Knowledge Graph
- Explore the **knowledge graph**, inspect *entities and relationships*, and debug data connections
- **Click the "Knowledge Graph" button** to open the [Neo4j](https://neo4j.com/) Browser directly
