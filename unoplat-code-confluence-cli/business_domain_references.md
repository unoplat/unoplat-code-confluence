...
## Domain Summary
Unoplat Code Confluence CLI manages a local Docker Compose deployment for repository-aware AI code assistance, coordinating Flow Bridge, a query engine, and a frontend. It normalizes and registers Git repositories, verifies repository-provider tokens and model-provider credentials, manages versioned GitHub release manifests and installed state, and starts AGENTS.md generation workflows that automatically raise pull requests.
