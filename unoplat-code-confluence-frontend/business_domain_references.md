...
## Domain Summary
This frontend supports a code-analysis and repository-operations platform that onboards GitHub/GitLab repositories, ingests codebases through tracked workflow runs, and presents AI-agent outputs including engineering workflows, dependency guides, business-logic summaries, interface scans, progress, events, and usage statistics. It also manages repository credentials, model and tool provider configuration including OAuth, and app or agent feedback that can be filed as GitHub issues.
