...
## Domain Summary
This frontend supports a code-intelligence and repository-operations platform that onboards source-control repositories, ingests their codebases, and tracks analysis workflow runs and per-codebase status. It presents AI-agent-generated repository artifacts—such as engineering workflows, dependency guides, interface findings, and event histories—while supporting provider credentials, model/tool configuration, OAuth, and feedback-to-GitHub-issue workflows.
