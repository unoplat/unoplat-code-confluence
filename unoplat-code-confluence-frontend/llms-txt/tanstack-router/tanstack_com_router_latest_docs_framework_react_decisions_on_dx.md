...
- [TanStack Router's origin story](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx#tanstack-routers-origin-story)
- [How does TanStack Router achieve this?](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx#how-does-tanstack-router-achieve-this)
- [1\. Why is the Router's configuration done this way?](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx#1-why-is-the-routers-configuration-done-this-way)
- [2\. Declaring the Router instance for type inference](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx#2-declaring-the-router-instance-for-type-inference)
- [3\. Why is file-based routing the preferred way to define routes?](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx#3-why-is-file-based-routing-the-preferred-way-to-define-routes)
...
1. [**Route configuration boilerplate?**](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx/#1-why-is-the-routers-configuration-done-this-way): You have to define your routes in a way that allows TypeScript to infer the types of your routes as much as possible.
2. [**TypeScript module declaration for the router?**](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx/#2-declaring-the-router-instance-for-type-inference): You have to pass the Router instance to the rest of your application using TypeScript's module declaration.
3. [**Why push for file-based routing over code-based?**](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx/#3-why-is-file-based-routing-the-preferred-way-to-define-routes): We push for file-based routing as the preferred way to define your routes.
...
You can read more about [code-based routing](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing) to see how to define your routes in this way.

Tip

Finding Code-based routing to be a bit too cumbersome? See why [file-based routing](https://tanstack.com/router/latest/docs/framework/react/decisions-on-dx/#3-why-is-file-based-routing-the-preferred-way-to-define-routes) is the preferred way to define your routes.
...
Before you continue, it's important you have a good understanding of [code-based routing](https://tanstack.com/router/latest/docs/framework/react/routing/code-based-routing) and [file-based routing](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing).
...
Check out the guides for [file-based routing](https://tanstack.com/router/latest/docs/framework/react/routing/file-based-routing) and [code-splitting](https://tanstack.com/router/latest/docs/framework/react/routing/code-splitting) for a more in-depth explanation of how they work in TanStack Router.

[Edit on GitHub](https://github.com/tanstack/router/tree/main/docs/router/framework/react/decisions-on-dx.md)

[Migrate from React Location](https://tanstack.com/router/latest/docs/framework/react/migrate-from-react-location)

[Frequently Asked Questions](https://tanstack.com/router/latest/docs/framework/react/faq)
...
![scarf analytics](https://static.scarf.sh/a.png?x-pxid=3d14fff2-f326-4929-b5e1-6ecf953d24f4&key=qtgtb)
