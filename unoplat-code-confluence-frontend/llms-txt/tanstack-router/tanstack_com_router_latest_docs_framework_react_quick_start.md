...
- [Using File-Based Route Generation](https://tanstack.com/router/latest/docs/framework/react/quick-start#using-file-based-route-generation)
- [Scaffolding Your First TanStack Router Project](https://tanstack.com/router/latest/docs/framework/react/quick-start#scaffolding-your-first-tanstack-router-project)
- [Manual Setup](https://tanstack.com/router/latest/docs/framework/react/quick-start#manual-setup)
- [Install TanStack Router, Vite Plugin, and the Router Devtools](https://tanstack.com/router/latest/docs/framework/react/quick-start#install-tanstack-router-vite-plugin-and-the-router-devtools)
- [Configure the Vite Plugin](https://tanstack.com/router/latest/docs/framework/react/quick-start#configure-the-vite-plugin)
- [`src/routes/__root.tsx`](https://tanstack.com/router/latest/docs/framework/react/quick-start#srcroutes__roottsx)
- [`src/routes/index.tsx`](https://tanstack.com/router/latest/docs/framework/react/quick-start#srcroutesindextsx)
- [`src/routes/about.tsx`](https://tanstack.com/router/latest/docs/framework/react/quick-start#srcroutesabouttsx)
- [`src/main.tsx`](https://tanstack.com/router/latest/docs/framework/react/quick-start#srcmaintsx)
...
If you are not using Vite, or any of the supported bundlers, you can check out the [TanStack Router CLI](https://tanstack.com/router/latest/docs/framework/react/routing/installation-with-router-cli) guide for more info.
...
[**src/routes/\_\_root.tsx**](https://tanstack.com/router/latest/docs/framework/react/quick-start#srcroutes__roottsx)
...
[Edit on GitHub](https://github.com/tanstack/router/tree/main/docs/router/framework/react/quick-start.md)
...
![scarf analytics](https://static.scarf.sh/a.png?x-pxid=3d14fff2-f326-4929-b5e1-6ecf953d24f4&key=6r2ma)