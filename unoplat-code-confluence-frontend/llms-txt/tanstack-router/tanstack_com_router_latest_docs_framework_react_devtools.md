...
- [Installation](https://tanstack.com/router/latest/docs/framework/react/devtools#installation)
- [Import the Devtools](https://tanstack.com/router/latest/docs/framework/react/devtools#import-the-devtools)
- [Using Devtools in production](https://tanstack.com/router/latest/docs/framework/react/devtools#using-devtools-in-production)
- [Using inside of the `RouterProvider`](https://tanstack.com/router/latest/docs/framework/react/devtools#using-inside-of-the-routerprovider)
- [Manually passing the Router Instance](https://tanstack.com/router/latest/docs/framework/react/devtools#manually-passing-the-router-instance)
- [Floating Mode](https://tanstack.com/router/latest/docs/framework/react/devtools#floating-mode)
- [Fixed Mode](https://tanstack.com/router/latest/docs/framework/react/devtools#fixed-mode)
- [Options](https://tanstack.com/router/latest/docs/framework/react/devtools#options)
- [Embedded Mode](https://tanstack.com/router/latest/docs/framework/react/devtools#embedded-mode)
- [Options](https://tanstack.com/router/latest/docs/framework/react/devtools#options-1)
...
[Edit on GitHub](https://github.com/tanstack/router/tree/main/docs/router/framework/react/devtools.md)
...
![scarf analytics](https://static.scarf.sh/a.png?x-pxid=3d14fff2-f326-4929-b5e1-6ecf953d24f4&key=p24ami)