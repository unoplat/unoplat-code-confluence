...
- [Anatomy of a Route](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts#anatomy-of-a-route)
- [The Root Route](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts#the-root-route)
- [Basic Routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts#basic-routes)
- [Index Routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts#index-routes)
...
- [Non-Nested Routes](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts#non-nested-routes)
- [Pathless Route Group Directories](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts#pathless-route-group-directories)
...
All other routes, other than the [Root Route](https://tanstack.com/router/latest/docs/framework/react/routing/routing-concepts/#the-root-route), are configured using the createFileRoute function, which provides type safety when using file-based routing:
...
To learn more about Context in TanStack Router, see the [Router Context](https://tanstack.com/router/latest/docs/framework/react/guide/router-context) guide.
...
[Edit on GitHub](https://github.com/tanstack/router/tree/main/docs/router/framework/react/routing/routing-concepts.md)
...
![scarf analytics](https://static.scarf.sh/a.png?x-pxid=3d14fff2-f326-4929-b5e1-6ecf953d24f4&key=rs7av)
