...
export const useAgentGenerationUIStore = create<AgentGenerationUIState>()(
  (set) => ({
    activeTab: null,
    isDialogOpen: false,
    isPreviewOpen: false,
    ...
    closeDialog: () =>
      set({ isDialogOpen: false, selectedRepository: null, activeTab: null }),
