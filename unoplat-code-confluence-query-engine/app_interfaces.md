...
| Repository agent rules | `GET /codebase-agent-rules`, `GET /repository-agent-snapshot`, `POST /repository-agent-md-pr`, `GET /repository-agent-md-pr` | `src/unoplat_code_confluence_query_engine/api/v1/endpoints/codebase_agent_rules.py` | Rules metadata, snapshot payloads, and markdown PR workflows for repository agents. |
