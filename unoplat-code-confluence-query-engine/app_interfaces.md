...
- `src/unoplat_code_confluence_query_engine/api/v1/endpoints/codebase_agent_rules.py`: L128: @router.get("/codebase-agent-rules")
- `src/unoplat_code_confluence_query_engine/api/v1/endpoints/codebase_agent_rules.py`: L253: @router.post("/repository-agent-run/cancel")
- `src/unoplat_code_confluence_query_engine/api/v1/endpoints/codebase_agent_rules.py`: L387: @router.get("/repository-agent-snapshot")
- `src/unoplat_code_confluence_query_engine/api/v1/endpoints/codebase_agent_rules.py`: L513: @router.post("/repository-agent-md-pr")
- `src/unoplat_code_confluence_query_engine/api/v1/endpoints/codebase_agent_rules.py`: L573: @router.get("/repository-agent-md-pr")
