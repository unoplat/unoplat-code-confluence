...
- `src/unoplat_code_confluence_query_engine/services/temporal/activities/app_interfaces_activity.py`: L32: @activity.defn
- `src/unoplat_code_confluence_query_engine/services/temporal/activities/app_interfaces_activity.py`: L70: @activity.defn
- `src/unoplat_code_confluence_query_engine/services/temporal/activities/app_interfaces_activity.py`: L88: @activity.defn
...
- `src/unoplat_code_confluence_query_engine/services/temporal/activities/codebase_workflow_run/app_interfaces_activity.py`: L100: @activity.defn
- `src/unoplat_code_confluence_query_engine/services/temporal/activities/codebase_workflow_run/app_interfaces_activity.py`: L118: @activity.defn
- `src/unoplat_code_confluence_query_engine/services/temporal/activities/codebase_workflow_run/app_interfaces_activity.py`: L38: @activity.defn
- `src/unoplat_code_confluence_query_engine/services/temporal/activities/codebase_workflow_run/app_interfaces_activity.py`: L78: @activity.defn
...
- `src/unoplat_code_confluence_query_engine/services/temporal/interceptors/agent_workflow/activity/repository_agent_snapshot_activity.py`: L24: @activity.defn(name="persist-agent-snapshot-begin-run")
- `src/unoplat_code_confluence_query_engine/services/temporal/interceptors/agent_workflow/activity/repository_agent_snapshot_activity.py`: L54: @activity.defn(name="complete-repository-activity")
- `src/unoplat_code_confluence_query_engine/services/temporal/interceptors/agent_workflow/activity/repository_agent_snapshot_activity.py`: L66: @activity.defn(name="persist-agent-snapshot-codebase-patch")
- `src/unoplat_code_confluence_query_engine/services/temporal/interceptors/agent_workflow/activity/repository_agent_snapshot_activity.py`: L96: @activity.defn(name="persist-agent-snapshot-complete")
...
- `src/unoplat_code_confluence_query_engine/services/temporal/workflows/codebase_agent_workflow.py`: L50: @workflow.defn(versioning_behavior=common.VersioningBehavior.AUTO_UPGRADE)
- `src/unoplat_code_confluence_query_engine/services/temporal/workflows/repository_agent_workflow.py`: L44: @workflow.defn(versioning_behavior=common.VersioningBehavior.AUTO_UPGRADE)

## Outbound Constructs

### db_sql (sqlalchemy)

- `src/unoplat_code_confluence_query_engine/db/postgres/code_confluence_framework_repository.py`: L731: session.add(usage_row)
- `src/unoplat_code_confluence_query_engine/main.py`: L219: session.add(Flag(name="isModelConfigured", status=model_configured))
- `src/unoplat_code_confluence_query_engine/services/config/ai_model_config_service.py`: L257: session.add(new_config)
- `src/unoplat_code_confluence_query_engine/services/config/ai_model_config_service.py`: L323: session.delete(config)
- `src/unoplat_code_confluence_query_engine/services/config/credentials_service.py`: L219: session.add(row)
- `src/unoplat_code_confluence_query_engine/services/config/credentials_service.py`: L256: session.delete(row)
- `src/unoplat_code_confluence_query_engine/services/config/credentials_service.py`: L473: session.add(row)
- `src/unoplat_code_confluence_query_engine/services/config/credentials_service.py`: L494: session.delete(row)
...
- `src/unoplat_code_confluence_query_engine/services/temporal/interceptors/agent_workflow/activity/codebase_workflow_db_activity.py`: L81: session.add(new_record)
- `src/unoplat_code_confluence_query_engine/services/temporal/interceptors/agent_workflow/activity/repository_workflow_db_activity.py`: L105: session.add(new_record)
- `src/unoplat_code_confluence_query_engine/services/temporal/interceptors/agent_workflow/activity/repository_workflow_db_activity.py`: L59: session.add(repository)
- `src/unoplat_code_confluence_query_engine/services/tracking/repository_agent_snapshot_service.py`: L199: insert(RepositoryAgentMdSnapshot)
- `src/unoplat_code_confluence_query_engine/services/tracking/repository_agent_snapshot_service.py`: L220: session.execute(snapshot_stmt)
- `src/unoplat_code_confluence_query_engine/services/tracking/repository_agent_snapshot_service.py`: L240: insert(RepositoryAgentCodebaseProgress)
- `src/unoplat_code_confluence_query_engine/services/tracking/repository_agent_snapshot_service.py`: L251: session.execute(progress_stmt)
- `src/unoplat_code_confluence_query_engine/services/tracking/repository_agent_snapshot_service.py`: L313: session.add( RepositoryAgentEvent( repository_owner_name=owner_name, repository_name=repo_name, repository_workflow_run_id=repository_workflow_run_id, codebase_name=codebase_name, event_id=allocated_event_id, event=agent_name, phase=phase, message=message, tool_name=tool_name, tool_call_id=tool_call_id, tool_args=_normalize_tool_args(tool_args), tool_result_content=tool_result_content, created_at=event_timestamp, ) )
- `src/unoplat_code_confluence_query_engine/services/tracking/repository_agent_snapshot_service.py`: L486: connection.execute( stmt, { "owner_name": owner_name, "repo_name": repo_name, "repository_workflow_run_id": repository_workflow_run_id, "codebase_name": codebase_name, "codebase_patch": codebase_patch, }, )
- `src/unoplat_code_confluence_query_engine/services/tracking/repository_agent_snapshot_service.py`: L546: update(RepositoryAgentMdSnapshot)
- `src/unoplat_code_confluence_query_engine/services/tracking/repository_agent_snapshot_service.py`: L555: session.execute(stmt)
- `tests/db/test_business_logic_repository.py`: L102: session.add( UnoplatCodeConfluenceFile( file_path=TEST_SQL_FILE_PATH, codebase_qualified_name=TEST_CODEBASE_QUALIFIED_NAME, imports=[], has_data_model=False, data_model_positions={}, ) )
- `tests/db/test_business_logic_repository.py`: L112: session.add( Framework( language=TEST_LANGUAGE, library=TEST_PYDANTIC_LIBRARY, ) )
- `tests/db/test_business_logic_repository.py`: L118: session.add( Framework( language=TEST_LANGUAGE, library=TEST_SQL_LIBRARY, ) )
- `tests/db/test_business_logic_repository.py`: L124: session.add( FrameworkFeature( language=TEST_LANGUAGE, library=TEST_PYDANTIC_LIBRARY, capability_key="data_model", operation_key="data_model", feature_definition=_build_feature_definition("Inheritance"), ) )
- `tests/db/test_business_logic_repository.py`: L133: session.add( FrameworkFeature( language=TEST_LANGUAGE, library=TEST_SQL_LIBRARY, capability_key="relational_database", operation_key="db_data_model", feature_definition=_build_feature_definition("Inheritance"), ) )
- `tests/db/test_business_logic_repository.py`: L143: session.add( UnoplatCodeConfluenceFileFrameworkFeature( file_path=TEST_PYDANTIC_FILE_PATH, feature_language=TEST_LANGUAGE, feature_library=TEST_PYDANTIC_LIBRARY, feature_capability_key="data_model", feature_operation_key="data_model", start_line=5, end_line=22, match_text="User", match_confidence=0.92, validation_status="completed", evidence_json=None, ) )
- `tests/db/test_business_logic_repository.py`: L158: session.add( UnoplatCodeConfluenceFileFrameworkFeature( file_path=TEST_SQL_FILE_PATH, feature_language=TEST_LANGUAGE, feature_library=TEST_SQL_LIBRARY, feature_capability_key="relational_database", feature_operation_key="db_data_model", start_line=10, end_line=34, match_text="InvoiceRecord", match_confidence=0.88, validation_status="completed", evidence_json=None, ) )
- `tests/db/test_business_logic_repository.py`: L177: session.execute( delete(UnoplatCodeConfluenceGitRepository).where( UnoplatCodeConfluenceGitRepository.qualified_name == TEST_REPOSITORY_QUALIFIED_NAME ) )
- `tests/db/test_business_logic_repository.py`: L178: delete(UnoplatCodeConfluenceGitRepository)
- `tests/db/test_business_logic_repository.py`: L183: session.execute( delete(FrameworkFeature).where( FrameworkFeature.language == TEST_LANGUAGE, FrameworkFeature.library.in_( [ TEST_PYDANTIC_LIBRARY, TEST_SQL_LIBRARY, ] ), ) )
- `tests/db/test_business_logic_repository.py`: L184: delete(FrameworkFeature)
- `tests/db/test_business_logic_repository.py`: L194: session.execute( delete(Framework).where( Framework.language == TEST_LANGUAGE, Framework.library.in_( [ TEST_PYDANTIC_LIBRARY, TEST_SQL_LIBRARY, ] ), ) )
- `tests/db/test_business_logic_repository.py`: L195: delete(Framework)
- `tests/db/test_business_logic_repository.py`: L48: session.execute( delete(UnoplatCodeConfluenceGitRepository).where( UnoplatCodeConfluenceGitRepository.qualified_name == TEST_REPOSITORY_QUALIFIED_NAME ) )
- `tests/db/test_business_logic_repository.py`: L49: delete(UnoplatCodeConfluenceGitRepository)
- `tests/db/test_business_logic_repository.py`: L54: session.execute( delete(FrameworkFeature).where( FrameworkFeature.language == TEST_LANGUAGE, FrameworkFeature.library.in_( [ TEST_PYDANTIC_LIBRARY, TEST_SQL_LIBRARY, ] ), ) )
- `tests/db/test_business_logic_repository.py`: L55: delete(FrameworkFeature)
- `tests/db/test_business_logic_repository.py`: L65: session.execute( delete(Framework).where( Framework.language == TEST_LANGUAGE, Framework.library.in_( [ TEST_PYDANTIC_LIBRARY, TEST_SQL_LIBRARY, ] ), ) )
- `tests/db/test_business_logic_repository.py`: L66: delete(Framework)
- `tests/db/test_business_logic_repository.py`: L77: session.add( UnoplatCodeConfluenceGitRepository( qualified_name=TEST_REPOSITORY_QUALIFIED_NAME, repository_url="https://example.com/business-repo.git", repository_name="business-repo", ) )
- `tests/db/test_business_logic_repository.py`: L84: session.add( UnoplatCodeConfluenceCodebase( qualified_name=TEST_CODEBASE_QUALIFIED_NAME, repository_qualified_name=TEST_REPOSITORY_QUALIFIED_NAME, name="business-codebase", codebase_path=TEST_CODEBASE_PATH, programming_language=TEST_LANGUAGE, ) )
- `tests/db/test_business_logic_repository.py`: L93: session.add( UnoplatCodeConfluenceFile( file_path=TEST_PYDANTIC_FILE_PATH, codebase_qualified_name=TEST_CODEBASE_QUALIFIED_NAME, imports=[], has_data_model=False, data_model_positions={}, ) )
- `tests/db/test_repository_agent_snapshot_service.py`: L69: sync_session.execute( text(""" INSERT INTO repository (repository_owner_name, repository_name, repository_provider) VALUES (:owner, :name, 'github_open') ON CONFLICT DO NOTHING """), {"owner": owner, "name": name}, )
- `tests/db/test_repository_agent_snapshot_service.py`: L84: sync_session.execute( text(""" INSERT INTO repository_workflow_run ( repository_owner_name, repository_name, repository_workflow_run_id, repository_workflow_id, operation, status, started_at ) VALUES (:owner, :name, :run_id, 'test-workflow-id', 'AGENTS_GENERATION', 'RUNNING', NOW()) ON CONFLICT DO NOTHING """), {"owner": owner, "name": name, "run_id": workflow_run_id}, )
- `tests/utils/sync_db_utils.py`: L81: session.execute(text("TRUNCATE TABLE repository CASCADE"))
...
- `src/unoplat_code_confluence_query_engine/services/github/agent_md_pr_service.py`: L421: GhApi( owner=owner_name, repo=repo_name, token=repository_pat, gh_host=github_host, )
...
- `src/unoplat_code_confluence_query_engine/services/temporal/agent_assembly/agents/architecture.py`: L82: Agent( context.model, name="architecture", instructions=build_architecture_instructions(), deps_type=ArchitectureAgentDependencies, tools=tuple(function_tools), toolsets=tuple(toolsets), capabilities=capabilities, output_type=str, retries={"output": 3}, end_strategy="early", model_settings=context.model_settings, )
- `src/unoplat_code_confluence_query_engine/services/temporal/agent_assembly/agents/business_domain.py`: L50: Agent( context.model, name="business_domain_guide", instructions=build_business_domain_instructions(), deps_type=AgentDependencies, tools=tuple(function_tools), capabilities=[console_capability], output_type=str, retries={"output": 3}, end_strategy="early", model_settings=context.model_settings, )
- `src/unoplat_code_confluence_query_engine/services/temporal/agent_assembly/agents/call_expression_discoverer.py`: L52: Agent( context.model, name="call_expression_discoverer", instructions=build_call_expression_discoverer_instructions(), deps_type=AgentDependencies, tools=tuple(function_tools), capabilities=[console_capability], output_type=DiscoveredFrameworkFeatureUsagesUpsertResult, output_retries=2, model_settings=context.model_settings, event_stream_handler=event_stream_handler, )
- `src/unoplat_code_confluence_query_engine/services/temporal/agent_assembly/agents/call_expression_validator.py`: L88: Agent( context.model, name="call_expression_validator", instructions=build_call_expression_validator_instructions(), deps_type=AgentDependencies, tools=tuple(function_tools), toolsets=tuple(toolsets), capabilities=capabilities, output_type=CallExpressionValidationAgentOutput, retries={"output": 2}, end_strategy="early", model_settings=context.model_settings, )
- `src/unoplat_code_confluence_query_engine/services/temporal/agent_assembly/agents/dependency_guide.py`: L83: Agent( context.model, name="dependency_guide", instructions=build_dependency_guide_instructions(), deps_type=AgentDependencies, tools=tuple(function_tools), toolsets=tuple(toolsets), capabilities=capabilities, output_type=DependencyGuideEntry, retries={"output": 2}, end_strategy="early", model_settings=context.model_settings, )
- `src/unoplat_code_confluence_query_engine/services/temporal/agent_assembly/agents/development_workflow.py`: L106: Agent( context.model, name="development_workflow_guide", instructions=build_development_workflow_instructions(), deps_type=AgentDependencies, toolsets=tuple(toolsets), capabilities=capabilities, output_type=EngineeringWorkflowAgentOutput, retries={"output": 2}, end_strategy="early", model_settings=context.model_settings, )
- `src/unoplat_code_confluence_query_engine/services/temporal/agent_assembly/assembler.py`: L92: TemporalAgent( build_result.agent, event_stream_handler=build_result.event_stream_handler, activity_config=activity_config.activity_config, model_activity_config=activity_config.model_activity_config, toolset_activity_config=activity_config.toolset_activity_config, tool_activity_config=activity_config.tool_activity_config, )
- `tests/services/test_development_workflow_runtime.py`: L173: Agent( model, deps_type=AgentDependencies, output_type=EngineeringWorkflowAgentOutput, retries={"output": 1}, )
- `tests/services/test_development_workflow_runtime.py`: L255: Agent( model, deps_type=AgentDependencies, output_type=PromptedOutput(EngineeringWorkflowAgentOutput), retries={"output": 1}, )

### task_queue_enqueue (temporalio)

- `src/unoplat_code_confluence_query_engine/services/temporal/interceptors/agent_workflow/inbound.py`: L154: workflow.execute_activity( RepositoryWorkflowDbActivity.update_repository_workflow_status, args=[running_envelope], start_to_close_timeout=DB_ACTIVITY_TIMEOUT, retry_policy=DB_ACTIVITY_RETRY_POLICY, )
- `src/unoplat_code_confluence_query_engine/services/temporal/interceptors/agent_workflow/inbound.py`: L181: workflow.execute_activity( RepositoryAgentSnapshotActivity.persist_agent_snapshot_begin_run, args=[begin_envelope], start_to_close_timeout=DB_ACTIVITY_TIMEOUT, retry_policy=DB_ACTIVITY_RETRY_POLICY, )
- `src/unoplat_code_confluence_query_engine/services/temporal/interceptors/agent_workflow/inbound.py`: L219: workflow.execute_activity( RepositoryWorkflowDbActivity.update_repository_workflow_status, args=[final_envelope], start_to_close_timeout=DB_ACTIVITY_TIMEOUT, retry_policy=DB_ACTIVITY_RETRY_POLICY, )
- `src/unoplat_code_confluence_query_engine/services/temporal/interceptors/agent_workflow/inbound.py`: L293: workflow.execute_activity( CodebaseWorkflowDbActivity.update_codebase_workflow_status, args=[running_envelope], start_to_close_timeout=DB_ACTIVITY_TIMEOUT, retry_policy=DB_ACTIVITY_RETRY_POLICY, )
- `src/unoplat_code_confluence_query_engine/services/temporal/interceptors/agent_workflow/inbound.py`: L338: workflow.execute_activity( CodebaseWorkflowDbActivity.update_codebase_workflow_status, args=[final_envelope], start_to_close_timeout=DB_ACTIVITY_TIMEOUT, retry_policy=DB_ACTIVITY_RETRY_POLICY, )
- `src/unoplat_code_confluence_query_engine/services/temporal/interceptors/agent_workflow/inbound.py`: L365: workflow.execute_activity( RepositoryWorkflowDbActivity.update_repository_workflow_status, args=[parent_failed_envelope], start_to_close_timeout=DB_ACTIVITY_TIMEOUT, retry_policy=DB_ACTIVITY_RETRY_POLICY, )
...
- `src/unoplat_code_confluence_query_engine/services/temporal/workflows/runners/app_interfaces_runner.py`: L120: workflow.execute_activity( AppInterfacesActivity.emit_app_interfaces_completion, args=[ repository_qualified_name, repository_workflow_run_id, codebase_metadata.codebase_name, codebase_metadata.codebase_programming_language, ], start_to_close_timeout=timedelta(seconds=30), retry_policy=DB_ACTIVITY_RETRY_POLICY, )
- `src/unoplat_code_confluence_query_engine/services/temporal/workflows/runners/app_interfaces_runner.py`: L65: workflow.execute_activity( AppInterfacesActivity.fetch_call_expression_discovery_targets, args=[ codebase_metadata.codebase_path, codebase_metadata.codebase_programming_language, ], start_to_close_timeout=timedelta(minutes=2), retry_policy=DB_ACTIVITY_RETRY_POLICY, )
- `src/unoplat_code_confluence_query_engine/services/temporal/workflows/runners/app_interfaces_runner.py`: L90: workflow.execute_activity( AppInterfacesActivity.build_app_interfaces, args=[ codebase_metadata.codebase_path, codebase_metadata.codebase_programming_language, ], start_to_close_timeout=timedelta(minutes=2), retry_policy=DB_ACTIVITY_RETRY_POLICY, )
- `src/unoplat_code_confluence_query_engine/services/temporal/workflows/runners/app_interfaces_runner.py`: L99: workflow.execute_activity( AppInterfacesActivity.write_app_interfaces, args=[ codebase_metadata.codebase_path, app_interfaces_result, ], start_to_close_timeout=timedelta(seconds=30), retry_policy=DB_ACTIVITY_RETRY_POLICY, )
- `src/unoplat_code_confluence_query_engine/services/temporal/workflows/runners/architecture_runner.py`: L127: workflow.execute_activity( RepositoryAgentSnapshotActivity.complete_repository_activity, args=[ RepositoryActivityCompletionEnvelope( owner_name=owner_name, repo_name=repo_name, repository_workflow_run_id=repository_workflow_run_id, activity_name=ARCHITECTURE_REPOSITORY_ACTIVITY, ) ], start_to_close_timeout=timedelta(seconds=30), retry_policy=DB_ACTIVITY_RETRY_POLICY, )
