...
| Repository agent rules | `GET /codebase-agent-rules`, `GET /repository-agent-snapshot` | `src/unoplat_code_confluence_query_engine/api/v1/endpoints/codebase_agent_rules.py` | Read-only rules and snapshot payloads for repository agents. |
