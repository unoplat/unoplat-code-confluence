...
class AiModelConfig(SQLBase):
    ...
    base_url: Mapped[Optional[str]] = mapped_column(default=None, comment="Custom endpoint URL")
    profile_key: Mapped[Optional[str]] = mapped_column(default=None, comment="Pydantic AI profile")
