...
CALL_EXPRESSION_VALIDATOR_CONSOLE_TOOLSET_ID = "console__call_expression_validator"
CALL_EXPRESSION_VALIDATOR_LOCAL_WEB_SEARCH_TOOLSET_ID = (
    "web_search__call_expression_validator"
)
CALL_EXPRESSION_VALIDATOR_LOCAL_WEB_FETCH_TOOLSET_ID = (
    "web_fetch__call_expression_validator"
)
