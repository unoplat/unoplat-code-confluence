...
## Domain Summary
This service is an AI-assisted codebase analysis and repository automation engine. It manages AI provider, OAuth, tool, and MCP-server configuration while orchestrating Temporal agents that inspect repositories, validate framework usage, track execution and LLM costs, and generate structured engineering, dependency, interface, and business-domain documentation. It persists per-codebase workflow snapshots and can publish generated AGENTS.md updates as pull requests.
...
- `/opt/unoplat/repositories/unoplat-code-confluence/unoplat-code-confluence-query-engine/src/unoplat_code_confluence_query_engine/services/temporal/agent_assembly/capabilities/readonly_console.py#L504-L577`
