...
## Domain Summary
This service is an AI-assisted codebase analysis and repository automation engine. It manages AI provider, OAuth, tool, and MCP configuration; orchestrates Temporal workflows that inspect repositories, document engineering workflows and dependencies, validate framework usage, and generate AGENTS.md pull requests. Repository snapshots, agent events, interface evidence, and LLM usage/cost statistics provide progress tracking and operational telemetry.
