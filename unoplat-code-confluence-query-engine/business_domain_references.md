...
## Domain Summary
This service is an AI-assisted codebase analysis and repository automation engine. It manages AI provider and OAuth configuration, MCP/tool setup, repository metadata, agent workflows, progress events, and LLM usage/cost telemetry. Temporal-driven agents inspect repositories to generate structured architecture, dependency, workflow, interface, and business-domain documentation, then can update AGENTS.md through pull requests.
