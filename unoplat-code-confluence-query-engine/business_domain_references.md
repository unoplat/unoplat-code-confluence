...
## Domain Summary
This service is an AI-assisted codebase analysis and repository automation engine. It manages AI-provider, OAuth, tool, and MCP-server configurations while orchestrating Temporal workflows that inspect repositories, track agent progress and LLM usage, validate framework features, and assemble structured documentation. Its primary outputs are engineering workflows, dependency guides, business-domain and interface summaries, plus AGENTS.md updates and pull requests.
