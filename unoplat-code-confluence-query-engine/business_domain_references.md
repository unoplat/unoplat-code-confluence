...
## Domain Summary
This is an AI-assisted codebase analysis and repository-automation service. It configures AI providers, OAuth and MCP tools; orchestrates Temporal agent workflows to inspect repositories, discover framework usage, and generate structured engineering, dependency, interface, and business-domain documentation. It tracks per-codebase progress, workflow snapshots, LLM usage and costs, and can publish AGENTS.md updates through pull requests.
