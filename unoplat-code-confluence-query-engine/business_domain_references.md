...
## Domain Summary
This service is an AI-assisted codebase analysis and repository automation engine. It orchestrates Temporal agent workflows to inspect repositories, capture framework and interface evidence, generate engineering, dependency, and business-domain documentation, and publish AGENTS.md updates through pull requests. Provider/OAuth and MCP tool configuration, repository snapshots and progress events, and LLM usage and cost statistics support operation of the agent runtime.

## Data Model References
### `/opt/unoplat/repositories/unoplat-code-confluence/unoplat-code-confluence-query-engine/scripts/update_d2_icon_catalog.py`
- `/opt/unoplat/repositories/unoplat-code-confluence/unoplat-code-confluence-query-engine/scripts/update_d2_icon_catalog.py#L38-L40`
...
- `/opt/unoplat/repositories/unoplat-code-confluence/unoplat-code-confluence-query-engine/src/unoplat_code_confluence_query_engine/services/temporal/agent_assembly/capabilities/readonly_console.py#L499-L575`

### `/opt/unoplat/repositories/unoplat-code-confluence/unoplat-code-confluence-query-engine/src/unoplat_code_confluence_query_engine/services/temporal/agent_assembly/capabilities/streaming_summarizing_compaction.py`
- `/opt/unoplat/repositories/unoplat-code-confluence/unoplat-code-confluence-query-engine/src/unoplat_code_confluence_query_engine/services/temporal/agent_assembly/capabilities/streaming_summarizing_compaction.py#L50-L99`
...
- `/opt/unoplat/repositories/unoplat-code-confluence/unoplat-code-confluence-query-engine/src/unoplat_code_confluence_query_engine/services/temporal/agent_assembly/search.py#L28-L31`
