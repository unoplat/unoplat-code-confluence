...
## Domain Summary
This service is an AI-assisted codebase analysis and repository automation engine. It manages AI model providers, OAuth credentials, MCP/tool configurations, repository metadata, and Temporal-based multi-agent workflows that analyze codebases and generate structured engineering, dependency, interface, and business-domain documentation. It tracks agent events, framework-feature validation, workflow snapshots, usage costs, and AGENTS.md pull-request publication.
