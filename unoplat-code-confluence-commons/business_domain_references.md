...
## Domain Summary
This package supports Code Confluence, a repository-ingestion and code-intelligence platform. It models Git repositories, codebases, source files, framework feature definitions and detections, package metadata, and credentials, while tracking repository and codebase workflow execution. It also records agent progress, event histories, generated AGENTS.md snapshots, and pull-request publication metadata.
