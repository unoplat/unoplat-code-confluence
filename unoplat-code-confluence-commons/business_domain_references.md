...
## Domain Summary
This package supports Code Confluence, a repository-ingestion and code-intelligence platform. It models repositories, codebases, source files, programming-language and package metadata, framework feature definitions, and detected code spans with confidence and validation evidence. It also manages repository and codebase workflow runs, agent progress and event histories, generated AGENTS.md snapshots and PR publication metadata, plus operational credentials and feature flags.
