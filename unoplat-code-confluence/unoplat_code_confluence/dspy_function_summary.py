...
class CodeConfluenceFunctionSummary(dspy.Signature):
    """This signature takes in unoplat_function_existing_summary , chapi_function_metadata and chapi_function_call metadata (one at a time) and returns unoplat_function_final_summary."""
    ...
    def forward(self, function_metadata: DspyUnoplatFunctionSubset, class_metadata: DspyUnoplatNodeSubset):
        ...
        for function_call in function_metadata.function_calls:
            ...
            if function_call.node_name == function_metadata.name:
                ...
                function_summary = self.generate_function_summary(unoplat_function_existing_summary=function_summary, chapi_function_call=current_function_call,chapi_function_metadata=function_subset).unoplat_function_final_summary
