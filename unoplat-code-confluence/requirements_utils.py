...
class RequirementsUtils:
    ...
    def parse_requirements_folder(workspace_path: str) -> List[UnoplatProjectDependency]:
        ...
        seen_deps: Set[str] = set()  # Track unique dependencies
            ...
            try:
                with open(req_file, 'r') as f:
                    for req in requirements.parse(f):
                        ...
                        if dep and dep.name not in seen_deps:
    ...
    def _convert_requirement_to_dependency(req) -> Optional[UnoplatProjectDependency]:
        ...
        try:
            ...
            if any(opt in req.line for opt in RequirementsUtils._SKIP_OPTIONS):
                return None
            ...
            return UnoplatProjectDependency(
                ...
                hash_info=f"{req.hash_name}:{req.hash}" if hasattr(req, 'hash_name') and req.hash_name else None
            )
        except Exception as e:
