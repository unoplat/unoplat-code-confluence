...
async def start_ingestion_process(config_path: str, github_token: str) -> None:
    ...
    try:
        ...
        connector = CodeConfluenceConnector(
            base_url=base_url,
...
@click.option('--config', required=True, type=click.Path(exists=True), 
              help='Path to the code confluence query engine configuration file.')
@click.option('--github-token', 'github_token', prompt='Enter your GitHub token',
              envvar='UNOPLAT_GITHUB_TOKEN',
