...
## Domain Summary
This service provides GitHub repository ingestion and code intelligence for software projects. It models repositories, codebases, source files, imports, package metadata, workspace layouts, and language/framework detection for downstream analysis. It also manages workflow execution status, GitHub App onboarding, and issue and user-feedback handling around the ingestion pipeline.
