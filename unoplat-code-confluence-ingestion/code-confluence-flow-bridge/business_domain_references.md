...
## Domain Summary
This service centers on GitHub repository ingestion and code intelligence. It models repositories, codebases, packages, source files, imports, dependency manifests, package-manager and workspace detection, and Python/TypeScript parsing for downstream analysis. It also manages GitHub App onboarding plus workflow status, operational issues, and feedback associated with repository-processing runs.
