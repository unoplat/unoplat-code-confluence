...
## [0.84.0](https://github.com/unoplat/unoplat-code-confluence/compare/code-confluence-flow-bridge-v0.83.0...code-confluence-flow-bridge-v0.84.0) (2026-06-11)
...
* **chore:** add comment to release docker builds ([d4e601f](https://github.com/unoplat/unoplat-code-confluence/commit/d4e601f3e403dadc33b6fe0ee8469c07dc2a332c))
...
* **ci:** refresh package uv lockfiles before python lock checks run ([94ce4e3](https://github.com/unoplat/unoplat-code-confluence/commit/94ce4e3511a69d74f2915f234456d2191f17b4bb))
...
* **codebase-detection:** add structured detection data models for rules, evidence, and results ([1222de9](https://github.com/unoplat/unoplat-code-confluence/commit/1222de976d6885cd1e9761cfbf28b3f4be6f215e))
...
* **codebase-detection:** add TypeScript monorepo detection and reorganize into typescript/ namespace ([b47e23d](https://github.com/unoplat/unoplat-code-confluence/commit/b47e23dfdccb2bde4f44ff5f54dd47501f6063cd))
...
* **codebase-detection:** extract shared parser infrastructure into shared/ namespace ([138bad7](https://github.com/unoplat/unoplat-code-confluence/commit/138bad7a1d7cd08c1ca335cec00a019b2b8507cf))
...
* **codebase-detection:** introduce StructuredLogger protocol and modernize trace_utils types ([35edf40](https://github.com/unoplat/unoplat-code-confluence/commit/35edf40d6762e1999a9450a4ec6d7b9423f914e8))
...
* **codebase-detection:** remove legacy flat-layout directories ([2d6765c](https://github.com/unoplat/unoplat-code-confluence/commit/2d6765cc7294705ca06a7324f539ad2c80a894a1))
...
* **codebase-detection:** remove original files superseded by namespace reorganization ([b30ba1c](https://github.com/unoplat/unoplat-code-confluence/commit/b30ba1c9cea496b893407e3bad33f484b4d68b6d))
...
* **codebase-detection:** reorganize Python package managers into python/ namespace ([ec01a96](https://github.com/unoplat/unoplat-code-confluence/commit/ec01a961d253b5958c3bafa17fb1eb3fd42eb23b))
...
* **codebase-detection:** update and relocate tests for refactored module layout ([450c745](https://github.com/unoplat/unoplat-code-confluence/commit/450c74589c37ed49780f2e77243dc2470a57101c))
...
* **codebase-detection:** update build config and project metadata ([7ea2fd4](https://github.com/unoplat/unoplat-code-confluence/commit/7ea2fd4f855f21b5bfbb20f4030825fbf6a25caa))
...
* **codebase-detection:** wire integration points to new module namespaces ([b4a7567](https://github.com/unoplat/unoplat-code-confluence/commit/b4a7567e601df7a9d06619db809a766b97c3704d))
...
* **flow-bridge:** add APIRouter support to FastAPI framework definitions ([c9f6d7a](https://github.com/unoplat/unoplat-code-confluence/commit/c9f6d7a47fd6edc57b2fbb91248fc1f5c145c969))
...
* **flow-bridge:** add pnpm-workspace.yaml support and negation glob handling ([ce2e78c](https://github.com/unoplat/unoplat-code-confluence/commit/ce2e78cd1ecbd56173f41b736f69494e1c8118ee))
...
* **flow-bridge:** extract credential, provider, and flag routers from main.py ([6f53d67](https://github.com/unoplat/unoplat-code-confluence/commit/6f53d67e175b84ea76d4af72483db74827ab7ce3))
...
* **flow-bridge:** extract repository and operations routers, slim down main.py ([36aa710](https://github.com/unoplat/unoplat-code-confluence/commit/36aa710ac3d572ad28f0b034bd4db53190e9724f))
...
* **flow-bridge:** extract shared backend utility modules from main.py ([195c4a8](https://github.com/unoplat/unoplat-code-confluence/commit/195c4a81003ac7cf48a2d1fa4c5ad008b03103dd))
...
* **flow-bridge:** improve TypeScript workspace detection for monorepos ([ad93ebf](https://github.com/unoplat/unoplat-code-confluence/commit/ad93ebfe784927e354a0ea792e550fdbbaf68512))
...
* **flow-bridge:** relax github helper language assertions ([8713348](https://github.com/unoplat/unoplat-code-confluence/commit/871334821c99def080cbce0b154e5577310d62e4))
...
* **test-data:** vendor turbo monorepo fixture files ([73d6e81](https://github.com/unoplat/unoplat-code-confluence/commit/73d6e81c1474293694162411c40cac2f82bef137))
...
* **flow-bridge:** relax github helper language assertions ([8713348](https://github.com/unoplat/unoplat-code-confluence/commit/871334821c99def080cbce0b154e5577310d62e4))
* **flow-bridge:** relax github helper language assertions ([85757e0](https://github.com/unoplat/unoplat-code-confluence/commit/85757e0a60631fba897a5efe7953de567118219e))
* **flow-bridge:** update package description ([3e62120](https://github.com/unoplat/unoplat-code-confluence/commit/3e6212046b05af73ff17a77720010b956cb603ab))
...
* **flow-bridge:** use Any type for workflow interceptor return types ([eee7c97](https://github.com/unoplat/unoplat-code-confluence/commit/eee7c97861a4d18bc1a5dac27db04183c4e59abd))
* **framework-defs:** align ingestion definitions with canonical capability keys and rename litellm to lit ([86e4b8c](https://github.com/unoplat/unoplat-code-confluence/commit/86e4b8ce94fdc697d03c699cc09fe65f7f27022a))
* **ingestion-docker-optimisation:** reuse cache and also update commons depenency ([7eded14](https://github.com/unoplat/unoplat-code-confluence/commit/7eded1409a4dde79be5e05c8eac0a0c892462983))
...
* **ingestion-test:** include base confidence for call-expression specs ([fd190df](https://github.com/unoplat/unoplat-code-confluence/commit/fd190df5f06d21f7ccccb54b949b54ebc355c93c))
...
* **docker-ci-cd-trigger:** pushing logging changes to fix docker buil… ([a51732b](https://github.com/unoplat/unoplat-code-confluence/commit/a51732be65453fb7dc99776a5549622ee20a02a0))
* **docker-ci-cd-trigger:** pushing logging changes to fix docker build trigger error ([db0395a](https://github.com/unoplat/unoplat-code-confluence/commit/db0395a690acac8baf5c535138e6c362155187d2))
* **docker:** pin uv image version for deterministic builds ([2cfe11d](https://github.com/unoplat/unoplat-code-confluence/commit/2cfe11d7590ea9a2bf537461986da15cecea1336))
* **docker:** pin uv image version for deterministic builds ([681624b](https://github.com/unoplat/unoplat-code-confluence/commit/681624b30f94c8aee9f6969f61d277aebc7c3763))
* fallback to owner name when no organisation exists for user repos ([632de8e](https://github.com/unoplat/unoplat-code-confluence/commit/632de8efd4c134c297f1ae15b904934380532c46))
* **flow-bridge:** add APIRouter support to FastAPI framework definitions ([c9f6d7a](https://github.com/unoplat/unoplat-code-confluence/commit/c9f6d7a47fd6edc57b2fbb91248fc1f5c145c969))
* **flow-bridge:** add pnpm-workspace.yaml support and negation glob handling ([ce2e78c](https://github.com/unoplat/unoplat-code-confluence/commit/ce2e78cd1ecbd56173f41b736f69494e1c8118ee))
* **flow-bridge:** align detection and ingestion tests with v4 operation keys ([bedba7a](https://github.com/unoplat/unoplat-code-confluence/commit/bedba7a87394250f428dc9df4c94e0a2841eabce))
* **flow-bridge:** extract credential, provider, and flag routers from main.py ([6f53d67](https://github.com/unoplat/unoplat-code-confluence/commit/6f53d67e175b84ea76d4af72483db74827ab7ce3))
...
* **flow-bridge:** improve TypeScript workspace detection for monorepos ([ad93ebf](https://github.com/unoplat/unoplat-code-confluence/commit/ad93ebfe784927e354a0ea792e550fdbbaf68512))
* **flow-bridge:** relax github helper language assertions ([8713348](https://github.com/unoplat/unoplat-code-confluence/commit/871334821c99def080cbce0b154e5577310d62e4))
* **flow-bridge:** replace loguru with workflow.logger in workflow outbound interceptor ([cc24445](https://github.com/unoplat/unoplat-code-confluence/commit/cc244452d2430821526e221afc7167abdb6f285e))
* **flow-bridge:** update package description ([3e62120](https://github.com/unoplat/unoplat-code-confluence/commit/3e6212046b05af73ff17a77720010b956cb603ab))
* **framework-defs:** align ingestion definitions with canonical capability keys and rename litellm to lit ([86e4b8c](https://github.com/unoplat/unoplat-code-confluence/commit/86e4b8ce94fdc697d03c699cc09fe65f7f27022a))
* **ingestion-docker-optimisation:** reuse cache and also update commons depenency ([7eded14](https://github.com/unoplat/unoplat-code-confluence/commit/7eded1409a4dde79be5e05c8eac0a0c892462983))
* **ingestion-test:** include base confidence for call-expression specs ([fd190df](https://github.com/unoplat/unoplat-code-confluence/commit/fd190df5f06d21f7ccccb54b949b54ebc355c93c))
* **ingestion:** recover from merge conflicts during git pull in github_helper ([a484121](https://github.com/unoplat/unoplat-code-confluence/commit/a484121640bf9c6ab06d52c48226df29c5976f4d))
* **logging:** add rotating file sinks for ingestion ([e8274d6](https://github.com/unoplat/unoplat-code-confluence/commit/e8274d6600c0e363f1a67d91ed8bf4131a753a78))
* **loguru-temporal:** Temporal workflow sandbox blocks multiprocessing.current_process(). Loguru calls that when building log records, and enqueue=True adds a multiprocessing queue, so moved to workflow logger instead of loguru for workflow ([4a91396](https://github.com/unoplat/unoplat-code-confluence/commit/4a91396108ca6c426c8578584625bb091a33dc93))
...
## [0.70.0](https://github.com/unoplat/unoplat-code-confluence/compare/code-confluence-flow-bridge-v0.69.2...code-confluence-flow-bridge-v0.70.0) (2026-03-03)
...
## [0.69.2](https://github.com/unoplat/unoplat-code-confluence/compare/code-confluence-flow-bridge-v0.69.1...code-confluence-flow-bridge-v0.69.2) (2026-03-03)
...
## [0.67.1](https://github.com/unoplat/unoplat-code-confluence/compare/code-confluence-flow-bridge-v0.67.0...code-confluence-flow-bridge-v0.67.1) (2026-01-20)
...
## [0.67.0](https://github.com/unoplat/unoplat-code-confluence/compare/code-confluence-flow-bridge-v0.66.3...code-confluence-flow-bridge-v0.67.0) (2026-01-20)
