...
> Generated from branch `dev` at commit `29472803c5188bd9b6c4aab5927632a203b7ca5d` (2026-08-07). Content may become stale as new commits land.
...
- Not detected
### Dev
- `task dev` (Taskfile.yml, `.`; starts Docker dependencies and runs the FastAPI development server)
### Test
- `task test` (Taskfile.yml, `.`; syncs the `test` dependency group, runs pytest with coverage, then stops dependencies)
### Lint
